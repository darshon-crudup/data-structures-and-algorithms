...
const addExclamation = (arr) => {
  let addExclamationArr = [];
  arr.forEach(string => addExclamationArr.push(string + '!'));
  return addExclamationArr;
};
...
const allUpperCase = (arr) => {
  let allUpperCase = [];
  arr.forEach(string => allUpperCase.push(string.toUpperCase()));
  return allUpperCase;
};
...
const greeting = (word) => {
  let greetingArr = [];
  arr.forEach(word => greetingArr.push(allUpperCase(string.toUpperCase + '!')));
  return greetingArr;
};

const speaker = (words, callback) => {
  let speaker = [];
  arr.forEach(words, (word) => speaker.push(allUpperCase(word)));
  return speaker;
};
